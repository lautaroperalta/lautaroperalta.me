...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 px-6 text-center overflow-hidden"
    >
      {/* Glow background */}
      ...
      >
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap">
          ...
          <Link
            ...
            duration={500}
            offset={-80}
            className="border-2 border-indigo-600 text-indigo-400 hover:bg-indigo-600/10 px-8 py-3 rounded-full font-semibold cursor-pointer transition-colors"
          >
            Contactarme
          </Link>
        </div>
